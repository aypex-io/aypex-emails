module Aypex
  class BaseMailer < ActionMailer::Base
    helper Aypex::MailHelper

    def current_store
      @current_store ||= @order&.store.presence || Aypex::Dependency.current_store_finder.constantize.new.execute
    end
    ...
    def money(amount, currency = nil)
      ...
      Aypex::Money.new(amount, currency: currency).to_s
    end
    helper_method :money

    def frontend_available?
      Aypex::Core::Engine.frontend_available?
    end
    ...
    def mail(headers = {}, &block)
      ...
      set_email_locale
      super if Aypex::Config.send_core_emails
    end
